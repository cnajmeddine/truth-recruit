        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900">{APP_CONFIG.name}</h3>
                <p className="text-sm text-gray-600">{APP_CONFIG.tagline}</p>
              </div>
            </div>
            <p className="text-gray-600 text-sm max-w-md">
              {APP_CONFIG.description}. Research companies before applying and avoid ghost jobs with our real-time intelligence platform.
            </p>
            <div className="mt-4">
              <p className="text-xs text-gray-500">
                Version {APP_CONFIG.version} • Made with ❤️ for job seekers
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/examples" className="text-gray-600 hover:text-gray-900 text-sm">Examples</a></li>
              <li><a href="/pricing" className="text-gray-600 hover:text-gray-900 text-sm">Pricing</a></li>
              <li><a href="/api-docs" className="text-gray-600 hover:text-gray-900 text-sm">API Docs</a></li>
            </ul>
          </div>
